...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_img.setMinimumSize(QtCore.QSize(210, 140))
        self.pushButton_img.setMaximumSize(QtCore.QSize(210, 140))
        ...
        self.pushButton_camera.setMinimumSize(QtCore.QSize(210, 140))
        self.pushButton_camera.setMaximumSize(QtCore.QSize(210, 140))
        ...
        self.pushButton_video.setMinimumSize(QtCore.QSize(210, 140))
        self.pushButton_video.setMaximumSize(QtCore.QSize(210, 140))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_video.setText(_translate("MainWindow", "Vedio Detection"))
    ...
    def button_image_open(self):
        ...
        showimg = self.detect_image(img)

        cv2.imwrite('predict/prediction.jpg', showimg)
    ...
    def button_video_open(self):
        ...
        if flag == False:
            QtWidgets.QMessageBox.warning(
                self, u"Warning", u"fail to open vdeio", buttons=QtWidgets.QMessageBox.Ok, defaultButton=QtWidgets.QMessageBox.Ok)
        else:
            self.out = cv2.VideoWriter('predict/Video_prediction.avi', cv2.VideoWriter_fourcc(
    ...
    def button_camera_open(self):
        if not self.timer_video.isActive():
            # default camera is the first local camera
            flag = self.cap.open(0)
            if flag == False:
                QtWidgets.QMessageBox.warning(
                    self, u"Warning", u"Fail to open camera", buttons=QtWidgets.QMessageBox.Ok, defaultButton=QtWidgets.QMessageBox.Ok)
            else:
                self.out = cv2.VideoWriter('predict/Camera_prediction.avi', cv2.VideoWriter_fourcc(
                    *'MJPG'), 20, (int(self.cap.get(3)), int(self.cap.get(4))))
                self.timer_video.start(30)
                self.pushButton_video.setDisabled(True)
                self.pushButton_img.setDisabled(True)
                self.pushButton_camera.setText(u"Close Camera")
        else:
